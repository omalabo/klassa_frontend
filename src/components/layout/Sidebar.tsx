    ...
    switch (userRole) {
      case 'eleve': {
        const fullMenu = [
          ...
          { to: '/eleve/classes', label: `${t('my_courses')}`, icon: '📚', mobileLabel: `${t('my_courses')}` },
      ...
      case 'professeur':
        return [
          ...
          { to: '/professeur/cours', label: `${t('my_courses')}`, icon: '🎓', mobileLabel: `${t('my_courses')}` },
    ...
    <>
      ...
      <aside className="hidden md:flex md:flex-col w-64 bg-white border-r border-neutral-200 h-screen sticky top-0">
        ...
        <div className="p-4 border-b border-neutral-200">
          <h1 className="text-xl font-bold text-primary-700">Klassa</h1>
        </div>
